<h2><a href="https://leetcode.com/problems/maximum-partition-factor/description/">3710. Maximum Partition Factor</a></h2><h3>Hard</h3><hr><p>You are given a 2D integer array <code>points</code>, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents the coordinates of the <code><font>i<sup>th</sup></font></code> point on the Cartesian plane.</p>
